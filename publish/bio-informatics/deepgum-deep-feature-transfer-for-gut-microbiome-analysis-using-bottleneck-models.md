...
**U-net** เป็นสถาปัตยกรรม Neural Network ที่ออกแบบมาเพื่อการแบ่งส่วนภาพ (Image Segmentation) ในกรณีนี้ U-net ถูกใช้ในการสกัดคุณลักษณะเชิงลึกจากข้อมูลทาง microbiome โดย U-net จะลดมิติของข้อมูลผ่าน Encoder แล้วขยายกลับมาผ่าน Decoder เช่นเดียวกับ Autoencoder ข้อมูลที่ถูกลดมิติผ่าน U-net สามารถใช้ในการทำนายโรคได้โดยโมเดลจำแนกเช่นเดียวกัน
...
โดยแต่ละส่วนใน DeepGum แสดงให้เห็นการใช้งานของโครงสร้าง **U-net** และ **Autoencoder** สำหรับการสกัดคุณลักษณะเชิงลึกในข้อมูล microbiome โดย **U-net1/4** และ **Autoencoder1/4** มีโครงสร้างครบทั้งการบีบอัดและการสร้างข้อมูลใหม่ ขณะที่ **U-net-encode1/4** และ **Encoder1/4** ใช้เฉพาะการบีบอัดข้อมูลเพื่อเลือกคุณลักษณะที่สำคัญ
...
- แม้ว่าโมเดล DeepGum จะแสดงผลลัพธ์ที่ดี แต่ยังคงต้องการการทดสอบเพิ่มเติมในชุดข้อมูลที่ใหญ่และมีความหลากหลายมากขึ้น เพื่อยืนยันความสามารถในการปรับตัวให้เข้ากับปัญหาต่างๆ ในข้อมูล  microbiome

---
### Conclusion and Future Work

การวิจัยนี้เสนอ **DeepGum** ซึ่งเป็นวิธีการสกัดคุณลักษณะเชิงลึกแบบไร้การกำกับที่มีประสิทธิภาพในการจัดการกับข้อมูล microbiome ที่มีมิติสูงและขนาดตัวอย่างเล็กได้ดี โดย DeepGum สามารถ Deep Feature Transfer ที่สกัดจาก Autoencoders และ U-nets เพื่อเพิ่มประสิทธิภาพในการจำแนกโรคที่เกี่ยวข้องกับระบบทางเดินอาหาร (IBD และ CRC) การทดลองแสดงให้เห็นว่าการใช้คุณลักษณะที่ได้จากโมเดล Encoder มีศักยภาพในการพัฒนาการจำแนกโรคที่แม่นยำกว่าโมเดลพื้นฐานเมื่อเทียบกับการใช้ข้อมูลต้นฉบับ
#### แนวทางในอนาคต
...
3. การขยายการประยุกต์ใช้ DeepGum ไปยังข้อมูล microbiome ชนิดอื่นๆ และโรคอื่นๆ เพื่อทำให้แนวทางนี้สามารถครอบคลุมการวินิจฉัยโรคได้กว้างขวางยิ่งขึ้น